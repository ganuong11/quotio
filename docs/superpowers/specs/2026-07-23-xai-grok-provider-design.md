...
Updated: 2026-08-10 — bumped bundled CPA from v7.2.113 to v7.2.124 (binary refreshed; see `ProxyBinarySource.plusLocalVersion`/`plusLocalSHA256`).
...
Bundle CLIProxyAPI **v7.2.124** as the Plus-local binary so xAI works out of the box.
...
- Replace `Quotio/Resources/Proxy/cli-proxy-api-plus` with CPA v7.2.124 darwin aarch64 binary (keep filename).
